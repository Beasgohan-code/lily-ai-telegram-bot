...
_ROLES = (
    ...
    AgentRole("deploy-pilot", "Deploy Pilot", "operations", "Guide install, start, stop, and host health checks.", "Deploy status"),
    AgentRole("url-guardian", "URL Guardian", "assurance", "Validate and shorten links without leaking secrets.", "Safe short link"),
    AgentRole("poll-designer", "Poll Designer", "product", "Craft clear poll questions and balanced options.", "Poll question and options"),
    AgentRole("channel-publisher", "Channel Publisher", "content", "Ship polished channel posts with pins and links.", "Channel publish checklist"),
    AgentRole("group-ops-lead", "Group Ops Lead", "community", "Coordinate bans, mutes, titles, and invites safely.", "Reviewable group action"),
...
_ACTION_ROLE = {
    ...
    "web_search": "research-scout", "wikipedia_search": "research-scout", "hackernews_feed": "research-scout",
    "weather_lookup": "data-analyst", "crypto_price": "data-analyst", "exchange_rate": "data-analyst",
    "define_word": "knowledge-curator", "anime_search": "anime-metadata-editor", "github_repo": "backend-architect",
    "dad_joke": "community-manager", "number_fact": "data-analyst", "ip_lookup": "security-engineer",
    "qr_code": "frontend-developer", "nasa_apod": "research-analyst", "cat_fact": "community-manager", "country_info": "data-analyst",
    "world_time": "data-analyst", "daily_quote": "channel-editor", "shorten_url": "media-engineer",
    "random_fact": "research-scout", "translate_text": "localization-reviewer", "free_tools_catalog": "knowledge-curator",
    "mangadex_search": "anime-metadata-editor", "mangadex_feed": "manga-tracker",
    ...
    "send_group_announcement": "community-moderator", "post_checklist": "community-moderator", "unpin_all_messages": "community-moderator", "set_chat_sticker_set": "community-moderator", "delete_chat_sticker_set": "community-moderator",
